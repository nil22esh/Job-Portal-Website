...
//get only myjobs for particular employer
export const getMyJobs = catchAsyncErrors(async (req, res, next) => {
  const { role } = req.user;
  if (role === "Job Seeker") {
    return next(
      new ErrorHandler(
        "Job Seeker Is Not Allowed To Access For This Resourse!",
        400
      )
    );
  }
...
// updating the posted job by user
...
// for deleteing posted job by user
